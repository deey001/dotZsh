...
# Set theme (use a simple theme, customizable later; disabled with Starship)
ZSH_THEME=""
...
# Custom prompt function (mirroring Bash style with Nerd Font, overridden by Starship)
